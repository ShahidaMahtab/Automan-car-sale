...
* Our Dashboard has secured admin section hidden from client where we can appoint a new admin, add new services , can manage all the services and orders ,if needed can remove and set status to shipping.
## Available Scripts
